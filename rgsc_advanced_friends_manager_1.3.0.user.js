...
(function() {
    ...
    $(document).ready(function(){
        ...
        //jesli user nie uzywa wersji en-US => daj info, i przycisk z przekierowaniem (i ciastkiem) na en-US
        if(location.hostname != 'socialclub.rockstargames.com' && location.hostname.substr(0,5) != 'scapi')
        {
            $('div#tytusowe_buttony.m').append('<button type=button id=main_button class="getFriendsFiltered UI__Button-socialclub__btn UI__Button-socialclub__success UI__Button-socialclub__medium" onclick="return false;">Skrypt RGSC Advanced Friends Manager działa wyłącznie w wersji angielsiej! Kliknij, aby zmienić język!</button>');

            $("body").on("click", "button#main_button", function(){
                setLang('en-US');
            });
        }

        //jesli user jest na en-US
        if(location.hostname == 'socialclub.rockstargames.com')
        {
            ...
            else
            {
                ...
                //przycisk powrotu do pl
                $('div#tytusowe_buttony.m').append('<button type=button id=main_button class="getFriendsFiltered UI__Button-socialclub__btn UI__Button-socialclub__success UI__Button-socialclub__medium" onclick="return false;">Kliknij, aby zmienić język, ponownie na Polski!</button>');
                $("body").on("click", "button#main_button", function(){
                    setLang('pl-PL');
                });
                ...
                if(localStorage.getItem('tt_pz') == 'show')
                {
                    ...
                    var tikTakToken = setInterval(function(){
                        ...
                        test.open("GET", "https://socialclub.rockstargames.com/", true)
